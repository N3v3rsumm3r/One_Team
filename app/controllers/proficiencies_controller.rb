class ProficienciesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @proficiency.save
        format.html { redirect_to proficiencies_url, notice: 'Proficiency was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @proficiency.update(proficiency_params)
        format.html { redirect_to proficiencies_url, notice: 'Proficiency was successfully updated.' }
